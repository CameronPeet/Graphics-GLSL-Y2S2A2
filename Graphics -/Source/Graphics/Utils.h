...
public:
	...
	static void SetCube(std::vector<VertexFormat>& const _rVertices, std::vector<GLuint>& const _krIndices);
	static void SetQuad(std::vector<VertexFormat>& const _rVertices, std::vector<GLuint>& const _krIndices);
	static void SetTriangle(std::vector<VertexFormat>& const _rVertices, std::vector<GLuint>& const _krIndices);
	static void SetPyramid(std::vector<VertexFormat>& const _rVertices, std::vector<GLuint>& const _krIndices);
	static void SetCircle(std::vector<VertexFormat>& const _rVertices, std::vector<GLuint>& const _krIndices);
	static void SetSphere(std::vector<VertexFormat>& const _rVertices, std::vector<GLuint>& const _krIndices);
